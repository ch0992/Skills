...
function installSkills() {
  ...
  console.log(`\nDone. Target: ${isLocal ? '--local (.claude/skills/)' : '--global (~/.claude/skills/)'}`);
}
...
switch (command) {
  ...
  default:
    console.log(`
Usage:
  npx github:yeonggyuchoi/claude-skills install           # global (~/.claude/skills/)
  npx github:yeonggyuchoi/claude-skills install --local  # local (.claude/skills/)
  npx github:yeonggyuchoi/claude-skills install --skill <name>
  npx github:yeonggyuchoi/claude-skills list
  npx github:yeonggyuchoi/claude-skills uninstall
`);
}
